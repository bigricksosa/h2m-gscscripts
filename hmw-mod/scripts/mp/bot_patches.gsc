...
bot_killstreak_setup_stub()
{
	if (!isdefined(level.killstreak_botfunc))
	{
		...
		bot_register_killstreak_func("predator_mp", maps\mp\bots\_bots_ks::bot_killstreak_simple_use, ::bot_killstreak_do_use);
		bot_register_killstreak_func("pavelow_mp", maps\mp\bots\_bots_ks::bot_killstreak_simple_use, ::bot_killstreak_do_use);
		bot_register_killstreak_func("airdrop_marker_mp", maps\mp\bots\_bots_ks::bot_killstreak_simple_use, ::bot_killstreak_do_use);
...
h2_set_bot_ks()
{
	...
	case 4:
		self.customKillstreaks[0] = "sentry_mp";
		self.customKillstreaks[1] = "harrier_airstrike_mp";
		self.customKillstreaks[2] = "pavelow_mp";
		break;

	case 5:
		self.customKillstreaks[0] = "harrier_strike_mp";
		self.customKillstreaks[1] = "ac130_mp";
		self.customKillstreaks[2] = "nuke_mp";
		break;
